        ...
        },
        {
            ...
            destinations = {
                ...
                menuHelper.destinations.setConditional("default crafting pillow hammock",
                    {
                        menuHelper.conditions.requireItem(
                            { "misc_clothbolt_01", "misc_clothbolt_02", "misc_clothbolt_03" }, 1)
                    })
            }
        },
        {
    ...
    buttons = {
        {
            ...
            destinations = {
                ...
                menuHelper.destinations.setConditional("reward generic plural",
                    ...
                    {
                        menuHelper.effects.removeItem({ "misc_clothbolt_01", "misc_clothbolt_02", "misc_clothbolt_03" },
                            1),
        ...
        },
        {
            ...
            destinations = {
                ...
                menuHelper.destinations.setConditional("reward generic plural",
                    {
                        menuHelper.conditions.requireItem(
                            { "misc_clothbolt_01", "misc_clothbolt_02", "misc_clothbolt_03" }, 4)
                    },
                    {
                        menuHelper.effects.removeItem({ "misc_clothbolt_01", "misc_clothbolt_02", "misc_clothbolt_03" },
                            4),
