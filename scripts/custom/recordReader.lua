...
local TypeHandlers = {
  ...
  Class = function(record, recordId)
    return tds.Hash {
      ...
      id = recordId,
      major1 = assert(Enums.SkillId[record.major1 or 'None']),
      major2 = assert(Enums.SkillId[record.major2 or 'None']),
      major3 = assert(Enums.SkillId[record.major3 or 'None']),
      major4 = assert(Enums.SkillId[record.major4 or 'None']),
      major5 = assert(Enums.SkillId[record.major5 or 'None']),
      minor1 = assert(Enums.SkillId[record.minor1 or 'None']),
      minor2 = assert(Enums.SkillId[record.minor2 or 'None']),
      minor3 = assert(Enums.SkillId[record.minor3 or 'None']),
      minor4 = assert(Enums.SkillId[record.minor4 or 'None']),
      minor5 = assert(Enums.SkillId[record.minor5 or 'None']),
      objectFlags = record.flags,
