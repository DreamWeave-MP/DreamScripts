    ...
    local addedVariableScopes = {
        globals = {
            ...
            personal = {
                ...
                "rent_balmora_council", "rent_balmora_lucky", "rent_aldruhn_skar", "rent_telaruhn_plot",
                "rent_telbran_sethan",
                "rent_telmora_covenant", "rent_vos_varo", "rent_balmora_eight", "rent_caldera_shenk",
                "rent_maargan_andus",
...
if tableHelper.containsCaseInsensitiveString(ClientDataFiles, "Bloodmoon.esm") then
    local addedVariableScopes = {
        globals = {
            ...
            quest = {
                -- main quest
                "foundbooze", "artoriachosen", "luciuschosen", "stones", "part", "aesliptalk", "skaalattack",
                "trackercount",
    ...
    local addedVariableScopes = {
        globals = {
            ignored = {
                ...
                -- card game
                "T_Glob_CardHortX", "T_Glob_CardHortY", "T_Glob_CardHortZ", "T_Glob_CardHortReshapeX",
                "T_Glob_CardHortReshapeY",
                ...
                "T_Glob_CardHortCol3Lock", "T_Glob_CardHortCol4Lock", "T_Glob_CardHortCol5Lock",
                "T_Glob_CardHortCol6Lock",
                "T_Glob_CardHortCol1Lock2", "T_Glob_CardHortCol2Lock2", "T_Glob_CardHortCol3Lock2",
                "T_Glob_CardHortCol4Lock2",
                "T_Glob_CardHortCol5Lock2", "T_Glob_CardHortCol6Lock2", "T_Glob_CardHortSaveLoad",
                "T_Glob_CardHortActiveLen",
                "T_Glob_CardHortTop", "T_Glob_CardHortDummy", "T_Glob_CardHortState", "T_Glob_CardHortTracker",
                "T_Glob_CardHortRow",
                ...
                "T_Glob_NineholesPlayerColor", "T_Glob_NineholesPlayerTurn", "T_Glob_NineholesPosTakenBy_01a",
                "T_Glob_NineholesPosTakenBy_01b",
                "T_Glob_NineholesPosTakenBy_01c", "T_Glob_NineholesPosTakenBy_02a", "T_Glob_NineholesPosTakenBy_02b",
                "T_Glob_NineholesPosTakenBy_02c",
                "T_Glob_NineholesPosTakenBy_03a", "T_Glob_NineholesPosTakenBy_03b", "T_Glob_NineholesPosTakenBy_03c",
            ...
            personal = {
                ...
                "T_Glob_Bank_Bri_AcctAmount", "T_Glob_Bank_Bri_LoanAmount", "T_Glob_Bank_Bri_LoanDate",
                "T_Glob_Bank_Bri_LoanFail",
                "T_Glob_Bank_Cmp_AcctAmount", "T_Glob_Bank_Cmp_LoanAmount", "T_Glob_Bank_Cmp_LoanDate",
                "T_Glob_Bank_Cmp_LoanFail",
                "T_Glob_Bank_Cro_AcctAmount", "T_Glob_Bank_Cro_LoanAmount", "T_Glob_Bank_Cro_LoanDate",
                "T_Glob_Bank_Cro_LoanFail",
                "T_Glob_Bank_Hla_AcctAmount", "T_Glob_Bank_Hla_LoanAmount", "T_Glob_Bank_Hla_LoanDate",
                "T_Glob_Bank_Hla_LoanFail",
                "T_Glob_Bank_Mas_AcctAmount", "T_Glob_Bank_Mas_LoanAmount", "T_Glob_Bank_Mas_LoanDate",
                ...
                "T_Glob_StockCompareWSC", "T_Glob_StockCountPlayerATC", "T_Glob_StockCountPlayerBIC",
                "T_Glob_StockCountPlayerCMC",
                "T_Glob_StockCountPlayerCWA", "T_Glob_StockCountPlayerEEC", "T_Glob_StockCountPlayerNWT",
                "T_Glob_StockCountPlayerRHC",
                "T_Glob_StockCountPlayerSTC", "T_Glob_StockCountPlayerWSC", "T_Glob_StockPayout001",
            ...
            worldwide = {
                ...
                -- objects
                "T_Glob_KingOrgCoffer_Uses", "T_Glob_KingOrgCoffer_Gold", "T_Glob_PlesioHatchPC",
                "T_Glob_TR_PreviewEnabled",
                -- news
                "T_Glob_News_AbMonitor_Pick1", "T_Glob_News_AbMonitor_Pick2", "T_Glob_News_AbMonitor_Tracker1",
                "T_Glob_News_AbMonitor_Tracker2",
                "T_Glob_News_Bellman_Pick1", "T_Glob_News_Bellman_Pick2", "T_Glob_News_Bellman_Tracker1",
                "T_Glob_News_Bellman_Tracker2",
                "T_Glob_News_Echo_Pick1", "T_Glob_News_Echo_Pick2", "T_Glob_News_Echo_Tracker1",
    ...
    local addedVariableScopes = {
        globals = {
            ignored = {
                ...
                -- player state
                "TR_m3_OE_armisticetheft", "TR_m3_OE_truearmistice", "tr_m3_bloodstone_help_T", "tr_m3_bloodstone_help_E",
                "tr_m3_bloodstone_help_T",
                "tr_m3_bloodstone_help_O", "tr_m3_bloodstone_help_B", "tr_m3_bloodstone_help_N",
                "tr_m3_bloodstone_help_L",
                -- player equipment
                ...
                -- quest variables that are already set correctly without being synced
                "TR_m3_bloodstonecheck", "TR_m4_MenaanTowerDoorGlobal", "TR_m4_Shenjirra_Gate",
                "TR_m4_TG_AncylisDoorGlobal",
                "TR_m4_TG_AndoSquatterSkooma", "TR_m4_TT_And_GoldCounter", "TR_m4_TT_And_GoldCounterB",
                "TR_m4_TT_And_ScripCounter",
                "TR_m4_WillToGoOn_Willpower", "TR_m4_vampvictim_incell", "TR_m7_EEC_SickGuar",
                "TR_m7_HH_Alvynu2_SlipInDesk",
                "TR_m7_HOSewerAlert", "TR_m7_Ns_FortunaQuestActive", "TR_m7_Ns_JNS_4_AnderaFollow",
                "TR_m7_Ns_JNS_4_FollowState",
                "TR_m7_Ns_JNS_4_ShouldFollow", "TR_m7_Ns_MG_Cont_glb", "TR_m7_Ns_TG_7_GoldIngots",
                ...
                "TR_m2_NisirelConfronted", "TR_m2_Rent_Helnim_Flower", "TR_m2_Rent_Helnim_Racer",
                "TR_m3_OE_TowerGhostTimer",
                "TR_m3_OE_smuggleeggsfound", "TR_m4_Andoth_AndasVaultGlobal", "TR_m4_Bal_MagicalLink",
            ...
            personal = {
                ...
                "TR_m1_Rent_Black_Ogre", "TR_m1_Rent_Dancing_Jug", "TR_m1_Rent_Howling_Noose",
                "TR_m1_Rent_Queens_Cutlass",
                "TR_m1_Rent_Waters_Shadow", "TR_m3_Rent_Sailen_Toiling", "TR_m3_Rent_Moth_and_Tiger",
                "TR_m3_Rent_Empress_Katariah",
                "TR_m3_Rent_Salty_Futtocks", "TR_m3_Rent_Vhul_Hound", "TR_m3_Rent_Aimrah_Inn", "TR_m3_Rent_AT_HC",
                "TR_m3_Rent_AT_LS",
                ...
                "TR_m4_Rent_Teyn", "TR_m4_Rent_Uman", "TR_m7_Rent_AldMarak", "TR_m7_Rent_FightingChance",
                "TR_m7_Rent_HK_Hound",
                "TR_m7_Rent_HK_Mudcrab", "TR_m7_Rent_MaarBani", "TR_m7_Rent_Mavandes", "TR_m7_Rent_Narsis_Canyon",
                "TR_m7_Rent_Narsis_Dragon",
                "TR_m7_Rent_Narsis_Greenshade", "TR_m7_Rent_Narsis_LastDrop", "TR_m7_Rent_Narsis_Temple",
                ...
                "TR_m3_Kha_Fountain_Cooldown", "TR_m3_Sa_PearlCurseTimer", "TR_m2_445_BlessingA", "TR_m2_445_BlessingS",
                "TR_m2_445_BlessingV",
                "TR_m4_Andas_VaultBreakInGlobal", "TR_m4_TG_ArantamoDispChange", "TR_m4_TT_OrcHostile",
            ...
            quest = {
                ...
                "TR_m7_HH_Dren_q_Orvas1_Seal", "TR_m7_HH_Dren_q_Vedam1_Seal", "TR_m7_HH_SvoshGlobal",
                "TR_m7_HH_UnsealedLlananu",
                "TR_m7_Ns_HH_SarithaSeal", "TR_m7_q_LetterToSodreru_seal", "tr_m7_oth_q_eldavelletter_seal",
                -- assassination quests
                -- Note: These are related to kill counts, but they make more sense being shared across
                --       players who share quests than being shared across players who share kills
                "TR_m3_Zanammu_LichDead", "TR_m2_q_27_guardkilled", "TR_m2_q_35_dead", "TR_m3_q_4_dead",
                "TR_m3_OE_TG_AntioDead",
                ...
                "TR_m1_FW_TG_StoneWorn", "TR_m1_HT_FakeLedgerPlanted", "TR_m1_IC6_Daisychainglobal",
                "TR_m1_IL_Darnelltalked",
                "TR_m1_Niv_JustASip_IncarnOwner", "TR_m1_RunningTroubleRewardFW", "TR_m1_TT_2_PTCommonersReward",
                "TR_m1_TT_2_PTSlavesReward",
                "TR_m1_TT_3_LTCommonersReward", "TR_m1_TT_5_RRTotalDealtWith", "TR_m2_Ak_HrothdorMad",
                "TR_m2_CantKill_MT",
                ...
                "TR_m3_AT_TG_Q1_OrdWarning", "TR_m3_Brother_HelmDropped", "TR_m3_Brother_HelmTaken",
                ...
                "TR_m3_EEC_SilverspoonTalks", "TR_m3_Hal_IndorilReward", "TR_m3_IrvasaSorvasInformed",
                "TR_m3_MT_DilsNoteFound",
                "TR_m3_OE_DAdelay", "TR_m3_WLCR_KidnappersGreet", "TR_m3_q_AdosiBiranDiscount", "TR_m3_q_DedicationFound",
                "TR_m3_q_3_thieving", "TR_Pilgrimages", "TR_m3_q_4_info", "TR_m3_q_3_info", "TR_m3_q_3_infoKiseen",
                "TR_m3_q_3_infoElegel",
                "TR_m3_q_3_infoTemple", "TR_m3_q_3_infoFarys", "TR_m3_q_3_infoFarysWife", "TR_m2_q_38_sabotage",
                "TR_m2_q_38_talkedto",
                "TR_m2_q_38_status", "TR_m2_q_A8_6_rushNPC", "TR_m3_q_3_rumour", "TR_m3_Bosvau_stolen",
                "TR_m3_Bosvau_stolenvalue",
                "TR_m3_q_3_guardsGone", "TR_m2_MG_Aka_seeds", "TR_m2_MG_Aka_Francine1", "TR_m2_MG_Aka_karma",
                "TR_m2_MG_Aka_Polodie1reward",
                "TR_m2_MG_Aka_tarry", "TR_m3_q_5_Journal_Read", "TR_m3_q_5_distantJulie", "TR_m3_q_OE_MG_GCount",
                "TR_m3_OE_FG_q_FledFromVermai",
                "TR_m3_OE_FG_q_AureCTalk", "TR_m3_q_givebartsword", "TR_m3_q_fiendbladegot", "TR_m3_q_fienddisappear",
                "TR_m3_q_treasurebladestolen",
                "TR_m3_OE_RumaGlobal", "TR_m3_q_NelynFathisTimer", "TR_m3_AT_SilentNight_stage",
                "TR_m3_AT_SilentNight_Rat",
                "TR_m3_q_TheRiftDral", "TR_m3_q_TheRiftTilresi", "TR_m3_OE_MG_HallOpen", "TR_m3_Aim_ShipSneak",
                "TR_m3_q_Kassad_QuestionedNumbe",
                "TR_m3_TT_ProverbCounter", "TR_m3_TT_Lloris4Indoril", "TR_m3_TT_Lloris4Hlaalu", "TR_m3_VysAssanudCheck",
                "TR_m3_TT_LatestRumorATGlobal",
                "TR_m3_Kha_SY_convinced", "TR_m3_Kha_SY_final", "TR_m3_TT_RIP_garvs_heresy", "TR_m3_TT_RIP_refusecount",
                "TR_m4_TJ_Court_State",
                "TR_m3_q_A3_Seen_Basement", "TR_m3_OE_elysanadiamondstole", "TR_m4_AA_BuriedSilver",
                "TR_m4_AA_DamiloBodyReveal",
                "TR_m4_AA_GuarCounter", "TR_m4_AA_GuarNassuran", "TR_m4_AA_GuarSeresa", "TR_m4_AA_IssarbaddonHostile",
                "TR_m4_AA_KuvatRent", "TR_m4_AA_SehutuFriend", "TR_m4_AA_UrnuridunGuarState",
                ...
                "TR_m4_AndoHH_ShipTrespass", "TR_m4_AndoHH_SujammaCheck", "TR_m4_AndoWharfHideoutGlobal",
                "TR_m4_Ando_AlchemistsTimeCtrl",
                "TR_m4_Ando_HemmetteArrestDay", "TR_m4_Ando_HemmetteDetected", "TR_m4_Ando_HemmetteRumor",
                "TR_m4_Ando_NevusaDeskState",
                "TR_m4_Ando_NevusaOffer", "TR_m4_Ando_NevusaPotionPlaced", "TR_m4_Bal0_ArmasSpoken",
                ...
                "TR_m4_T_Nuccius_Sujamma1", "TR_m4_T_Nuccius_Sujamma2", "TR_m4_T_Nuccius_Sujamma3",
                ...
                "TR_m7_AI_JNS_6_Glob", "TR_m7_AI_TT_HlerasConfrBefore", "TR_m7_AT_TG_Q6_Council_Booze",
                "TR_m7_EEC_Caravandelay",
                "TR_m7_EEC_Feast", "TR_m7_EEC_Narsis2_itemcount", "TR_m7_EEC_Narsis3_weightsplace",
                "TR_m7_EEC_Narsis_Book",
                "TR_m7_EEC_Narsis_Helm", "TR_m7_EEC_Narsis_Hide", "TR_m7_EEC_Narsis_Pot", "TR_m7_EEC_Narsis_Saltrice",
                "TR_m7_EEC_Narsis_Shield", "TR_m7_EEC_Narsis_Skirt", "TR_m7_FamilyAffair_RavosReturn",
                "TR_m7_FamilyAffair_TalkUlyne",
                "TR_m7_HH_Alvynu_4_SpeakerGhost", "TR_m7_HH_Alvynu_6_SpiritsDealt", "TR_m7_HH_AxeReturn",
                "TR_m7_HH_ElarFramed",
                "TR_m7_HH_FirstFamily_smug", "TR_m7_HH_HasGuarLiver", "TR_m7_HH_fixbreach", "TR_m7_HH_grandmasterask",
                "TR_m7_HL_FG_Q4_FightStarted", "TR_m7_HL_FG_Q5_SlavesFreed", "TR_m7_HL_FG_Q6_FightStarted",
                "TR_m7_HOGuideEnt",
                "TR_m7_HOGuideInf", "TR_m7_HOGuideRuin", "TR_m7_HO_HFS_HouseOffer", "TR_m7_HO_TT_01_Donations",
                "TR_m7_HO_TT_05_askedIda", "TR_m7_HO_TT_05_askedMG", "TR_m7_HO_TT_05_crooknotefound",
                "TR_m7_HO_TT_07_DadrysAngry",
                "TR_m7_HR_AldIuval_q1_ShojaFree", "TR_m7_HindsightPlanted", "TR_m7_IC_FeedPoorCountAI",
                ...
                "TR_m7_IC_HL_AlmsRuvene", "TR_m7_IC_HL_AlmsTaderi", "TR_m7_JNS_TheBoss_HammerReward",
                "TR_m7_Ns_ArenaCorrectDoor",
                "TR_m7_Ns_ArenaFightChoice", "TR_m7_Ns_BilchabulBetray", "TR_m7_Ns_BilchabulSuryvnAngry",
                ...
                "TR_m7_Ns_MG_Ench_Glb", "TR_m7_Ns_MG_QuestsDone_glb", "TR_m7_Ns_NucciusRumor",
                "TR_m7_Ns_StageFright_Mistakes",
                "TR_m7_Ns_TG_4_Greydust", "TR_m7_Ns_TG_8_GuardState", "TR_m7_Ns_TG_8_GuardWarn",
                ...
                "TR_m7_Oth_BrothersLove_Glob", "TR_m7_Oth_MG_ApproachEndRoom", "TR_m7_Oth_MG_ApproachSigilBarr",
                "TR_m7_Oth_MG_ApproachTeleKey",
                "TR_m7_Oth_MG_ApproachWaterRoom", "TR_m7_Oth_MG_MainDoorUnlocked", "TR_m7_Oth_MG_RubbleCleared",
                "TR_m7_Oth_MG_TeleDoorUnlocked",
                "TR_m7_SM_QuestStarted", "TR_m7_Sdr_Defiling_MuranAsked", "TR_m7_Sharai_TL_Access",
                "TR_m7_ShiSha_HH_Q4Flin",
                "TR_m7_ShiSha_Haunt_CleanCount", "TR_m7_TejNaFound", "TR_m7_VA_AniVamp_InfectCount",
            ...
            kills = {
                ...
                "TR_m2_HT_Vaerin_DaedraDead", "TR_m2_WindbreakerSmugglerDead", "TR_m3_AT_TG_Q6_ThugsDeadCount",
                "TR_m3_KadanuranDeadCount",
                "TR_m3_OE_RumaDead", "TR_m3_Sa_IdrenieDead", "TR_m3_WLCR_FightDeath", "TR_m3_WLCR_KidnappersDead",
                "TR_m3_q_RD_HlesGangDead", "TR_m4_AA_SehutuDead", "TR_m4_And_Bounty_Bone_Dead",
                "TR_m4_And_Bounty_Holst_Dead",
                "TR_m4_And_Bounty_Runat_Dead", "TR_m4_And_Bounty_Vyper_Dead", "TR_m4_And_Bounty_ra_Dead",
                "TR_m4_AndoHH_ZalanDeath",
                "TR_m4_Ando_HemmetteDead", "TR_m4_Ando_NevusaDead", "TR_m4_Bal_DevourerDead", "TR_m4_Barendreth_DeadOrd",
                "TR_m4_FG_AlitGlobal", "TR_m4_HH_WorkerDeathCounter", "TR_m4_LostTransit_AshDead_glb",
                ...
                "TR_m7_ErnasiViranDead", "TR_m7_EssurnashpiDeadCount", "TR_m7_HH_Alvynu2_Murder",
                "TR_m7_HH_Alvynu_7_CCKilled",
                "TR_m7_HL_FG_Q2_DeadCount", "TR_m7_HL_FG_Q5_DeadCount", "TR_m7_HL_FG_Q6_DeadCount",
                "TR_m7_HO_HighAndDry_CrewKilled",
                "TR_m7_HR_AM_Q1_AtemuNixDeath", "TR_m7_HR_AM_Q2_Shellcountdown", "TR_m7_HR_AM_Q4_BanditDead",
                "TR_m7_HR_WM_NilusDead",
                "TR_m7_Kalk_Fight_GoblinDead", "TR_m7_Kalk_Fight_OrcDead", "TR_m7_KurikiDeadCount",
                "TR_m7_Narsis_SM_killed",
                "TR_m7_NsTT_ShinApostKillCount", "TR_m7_Ns_ArenaBeast", "TR_m7_Ns_JNS_3_GuardiansKilled",
                "TR_m7_Ns_JNS_4_JandieGangKille",
                "TR_m7_Ns_JNS_7_NegotiatorsDead", "TR_m7_Ns_StageFright_ActorKill", "TR_m7_Oth_MG_1_SquatterDead",
            ...
            worldwide = {
                -- mechanisms
                "TR_Necrom_FanePortL", "TR_Necrom_FanePortR", "TR_m1_q_Bthal_CrystalTarget",
                ...
                "TR_m3_Aim_GilaWallBreak", "TR_m3_Aim_LighthouseSecretDoor", "TR_m3_OE_pitgate",
                "TR_m3_OE_CuriaVaultGate2",
                "TR_m3_OE_sewergate", "TR_m2_kmlz_Chef_WaterLevel", "TR_m3_OE_ETCensusBlockDoor",
                "TR_m3_OE_CuriaVaultGate", "TR_m3_OE_CuriaVaultGlobal", "TR_m3_OE_TG_waterlevel",
                "TR_m3_OE_chapelsewerdoor",
                ...
                "TR_m4_BthungthuvDoorGlobal", "TR_m4_FelmsLiftGlobal1", "TR_m4_FelmsLiftGlobal2",
                "TR_m4_ShalmuratGateAccess",
                "TR_m4_TG_AndoBaseLiftGlobal", "TR_m4_TG_AndoBaseLiftGlobal2", "TR_m4_UshuKurLiftGlobal",
                "TR_m4_UshuKurLiftGlobal2",
                "TR_m4_UshuKurLiftGlobal3", "TR_m4_UshuKurLiftGlobal4",
                -- building construction
                "TR_FM_Glob_State", "TR_m7_NVA_BuildStage", "TR_m3_OE_ETCensus_RepairState",
                "TR_m3_OE_ETCensus_Stanchion",
                "TR_m4_Oma_InnStage", "TR_m4_TG_AndoBaseBanners", "TR_m4_TG_AndoBaseBar", "TR_m4_TG_AndoBaseBeds",
                "TR_m4_TG_AndoBaseCleanUp", "TR_m4_TG_AndoBasePlants", "TR_m4_TG_AndoBaseRugs",
                ...
                "TR_m7_JNS_UddanuDaeCrossbowGlb", "TR_m7_SM_AlembicFound", "TR_m7_SM_CalcinatorFound",
                ...
                "TR_m4_TJ_OgrimStatus", "TR_m3_TT_Illene1_ChaseGlobal", "TR_m4_BahrundGlobal",
                "TR_m4_Bal_DevourerSpawned",
                "TR_m4_DredaseDevani", "TR_m4_FG_AndasInVault", "TR_m4_FG_JubalGlobal", "TR_m4_FG_OrblosGlobal",
                "TR_m4_HH_AnbarysGuardsMove", "TR_m4_HH_WorkerDisable", "TR_m4_SkelWiz_HlaaluEnabled",
                "TR_m4_TG_AndoSkoomaCat",
                "TR_m4_TJ_OgrimStatus", "TR_m4_T_Nuccius_Delay", "TR_m4_Uman_B2_DiraBrought", "TR_m4_q_TMM_Bolsleave",
                "TR_HH_GM_enable_trainers", "TR_m7_AI_JNS_4_Glob", "TR_m7_AI_TT_HouseSupport",
                "TR_m7_AI_TT_MuransFrustration",
                "TR_m7_FelvynGangEnable", "TR_m7_HH_Alvynu_4_IlvrinActive", "TR_m7_HH_Alvynu_5_AssState",
                "TR_m7_HH_Alvynu_6_TombState",
                "TR_m7_Ida_NetMoved", "TR_m7_JNS_TheBossAttacked", "TR_m7_MakingPeace_Return",
                "TR_m7_Ns_FortunaTongDisable",
                "TR_m7_Ns_IL_6_VanikenDeadGlb", "TR_m7_Ns_SlavesAvailableArg", "TR_m7_Ns_SlavesAvailableKha",
                "TR_m7_Ns_SlavesAvailableOth",
                "TR_m7_Oth_MG_1_SquatterState", "TR_m7_Proconsul_dead_glb", "TR_m7_VA_AniVamp_TestState",
                "TR_m7_VurvynOthrenDead",
                -- both
                "TR_m1_FG_StalkerTrapped", "TR_m3_Hal_TowerState", "TR_m3_veloth_shrine_spawncount",
                "TR_m4_Ando_HemmettePrison",
                "TR_m4_FG_UshuFree", "TR_m4_HH_SaboteurAction", "TR_m4_HH_SavrethiAlive", "TR_m4_HH_TeraniRescued",
                "TR_m4_LostTransit_Control_glb", "TR_m4_LostTransit_Days_glb", "TR_m4_Om_ReRe_Ordinators",
                "TR_m4_TG_AndoAttack",
                "TR_m4_TG_AndoShei6Global", "TR_m4_TG_AndoSideQuest", "TR_m4_TJ_Court_State", "TR_m4_TT_AndothrenFinale",
                "TR_m7_IbbiSuen_MineState", "TR_m7_Ns_IL_3_Culprit", "TR_m7_Ns_MoonshinerEnds",
                "TR_m7_Ns_RescuePotLady_Moved",
                -- events
                "TR_FM_Glob_Weather", "TR_m3_OE_StendarrIdolsOutlawed", "TR_Thirr_Conflict_Score",
                "TR_Thirr_Conflict_Heat",
                ...
                "TR_m7_Ns_ArenaDuelBegun", "TR_m7_Ns_ArenaGenericFight", "TR_m7_Ns_IL_7_Raid",
...
if tableHelper.containsCaseInsensitiveString(ClientDataFiles, "Cyr_Main.esm") then
    local addedVariableScopes = {
        globals = {
            ...
            personal = {
                -- tavern rents
                "PC_m1_Rented_Abecette", "PC_m1_Rented_AllFlags", "PC_m1_Rented_AnchorsRest",
                "PC_m1_Rented_BlindWatchtower",
                ...
                -- player actions
                "PC_m0_Vva_TropVac_TravelKaltan", "PC_m0_Vva_TropVac_TravelTitus", "PC_m1_Anv_BlkView_Detected",
                "PC_m1_Anv_BlkView_SoulGemType",
                "PC_m1_Anv_WorkOrc_Disp", "PC_m1_CrypsisCrew_Aggro", "PC_m1_IP_Lki4_StateRitual",
                "PC_m1_IP_Lki_DibellanKilled",
                "PC_m1_IP_Run2_Killed", "PC_m1_PadrulRingState", "PC_m1_SC_GarAge_ArchaeKilled",
                "PC_m1_SC_GarAge_AuroranSummoned",
                "PC_m1_SC_GarAge_BucynarelKeyst", "PC_m1_SC_GoatTrbls_Attacked", "PC_m1_TG_Anv4_BetAmount",
                "PC_m1_TG_Anv4_BetState",
            ...
            quest = {
                ...
                "PC_m1_Anv_AdvRead_BarubiState", "PC_m1_Anv_AdvRead_PotionOffered", "PC_m1_Anv_BlkView_Storming",
                "PC_m1_Anv_BookClub_State",
                "PC_m1_Anv_GlimpseBodyFound", "PC_m1_Anv_ImpCause_HasiDisobey", "PC_m1_Anv_OceanBlue_ATCGold",
                "PC_m1_BC_KhaRaji_SealedLtrGlb",
                "PC_m1_Cha_Cassynder_Drugs", "PC_m1_Cha_FigSpeech_AmulStolen", "PC_m1_Cha_PelLeg_Refuse",
                "PC_m1_FG_Anv5_PaintingOwner",
                "PC_m1_IP_Als3_NoteSkip", "PC_m1_IP_Als4_Convince", "PC_m1_IP_GS2_Donation", "PC_m1_IP_HY1_StateKuram",
                "PC_m1_IP_HY2_NoHostile", "PC_m1_IP_Lki4_KeladRattedOut", "PC_m1_IP_Lki4_PCDrowner",
                "PC_m1_IP_Run1_CanPay",
                ...
                "PC_m1_MG_BC3_RingCheck", "PC_m1_MG_Cha4_AuroranSummon", "PC_m1_MG_Cha4_BigUpArdavan",
                "PC_m1_StrokeFort_BeatUp",
                "PC_m1_TG_Anv7_Outcome", "PC_m1_TG_Anv7_Points", "PC_m1_Tvy_NobleDebt_Convinced",
                -- Bounty quests
                "PC_m1_Anv_Bounty_AnnkaCaptured", "PC_m1_Anv_Bounty_MCCaptured", "PC_m1_Anv_Bounty_RueCaptured",
                "PC_m1_Anv_Bounty_RycimaCaptured"
            },
            kills = {
                -- Misc quests
                "PC_m1_Anv_BookClub_DeadCount", "PC_m1_Anv_MidLife_BanditDead", "PC_m1_Anv_MidLife_OrcDead",
                "PC_m1_FG_Anv5_GuardDeath",
                "PC_m1_IP_HY2_BanditKilled", "PC_m1_K1_HT5_GuardDead", "PC_m1_K1_MC6_BoardKilled",
                "PC_m1_MG_Anv5_UndeadKilled",
            ...
            worldwide = {
                ...
                "PC_m1_Anv_Bounty_CrypsisMoved", "PC_m1_Anv_EnmanAirshipState", "PC_m1_Anv_EnmanAirshipState",
                "PC_m1_Anv_WellMet_TrackReymanus",
                "PC_m1_Anv_WellMet_TrackWynn", "PC_m1_Cha_GhastOrd_Moved", "PC_m1_Cha_GoldNets_Meeting",
                "PC_m1_Cha_MG_NymonaHatchGlob",
    ...
    local addedVariableScopes = {
        globals = {
            ...
            personal = {
                ...
                -- miscellaneous variables related to player-specific actions
                "Sky_qRe_BM4_Door_glb", "Sky_qRe_HA1_SkullPlaced_glb", "Sky_qRe_KW1a_Journal_glb",
                "Sky_qRe_KW1b_Journal_glb",
            ...
            quest = {
                ...
                "Sky_qRe_DSTG3_Informants_glb", "Sky_qRe_DSTG7_MoveCael_glb", "Sky_qRe_DSW1_CacheFound_glb",
                "Sky_qRe_DSW1_Dagger_glb",
                "Sky_qRe_DSW1_Scimitar_glb", "Sky_qRe_DSW1_Saber_glb", "Sky_qRe_DSW2_Auth_glb", "Sky_qRe_KG5_SViir_glb",
                "Sky_qRe_KWFG4_Owner_glb", "Sky_qRe_KWTG8_Owner_glb", "Sky_qRe_MAI4_Counter_glb",
                "Sky_qRe_NAR1_Investigate_glb"
            },
            kills = {
                -- main quest
                "Sky_qRe_DSMQ_AlaktolDead", "Sky_qRe_DSMQ_JonaDead",
                -- side quests
                "Sky_qRe_DSW1_MesaraDead_glb", "Sky_qRe_BM_FhegainDead_glb", "Sky_qRe_HA1_KillCheck_glb",
                "Sky_qRe_KG1_glb",
                ...
                -- arena kill counts
                "Sky_qRe_DSE4_Count02_glb", "Sky_qRe_DSE4_Count03_glb", "Sky_qRe_DSE4_Count05_glb",
                "Sky_qRe_DSE4_Count07_glb"
            },
            factionRanks = {
                -- faction reputation
            ...
            worldwide = {
                ...
                -- npc behavior
                "Sky_qRe_HA1_CultistState_glb", "Sky_qRe_HA3_Sick_glb", "Sky_qRe_KWMG4_Returned_glb",
                "Sky_qRe_VF1_Returned_Glb",
                -- arena State
